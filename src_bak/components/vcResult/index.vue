<template>
  <section :class="`result result-${status}`">
    <div class="result-icon" v-if="$slots.icon">
      <slot name="icon"></slot>
    </div>
    <template v-else>
      <div v-if="status == 'success'" class="result-icon">
      ...
      <div v-else-if="status == 'info'" class="result-icon">
      ...
      <div v-else-if="status == 'warning'" class="result-icon">
        <span role="img" aria-label="warning" class="anticon anticon-warning"
          ><svg
            focusable="false"
            class=""
            data-icon="warning"
      ...
      <div v-else-if="status == 'error'" class="result-icon">
      ...
      <div v-else-if="status == '403'" class="result-icon result-image">
      ...
      <div v-else-if="status == '404'" class="result-icon result-image">
      ...
      <div v-else-if="status == '500'" class="result-icon result-image">
    ...
    <div class="result-subtitle" v-if="subTitle">{{ subTitle }}</div>
