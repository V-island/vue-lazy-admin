<template>
  <el-card class="box-card" shadow="hover" style="margin-top: 5px">
    ...
    <el-table border :data="historicTaskList" style="width: 100%">
      <el-table-column prop="histIns.activityName" label="执行环节" width="180"> </el-table-column>
      <el-table-column prop="assigneeName" label="执行人" width="180"> </el-table-column>
      <el-table-column prop="histIns.startTime" label="开始时间"> </el-table-column>
      <el-table-column prop="histIns.endTime" label="结束时间"> </el-table-column>
      <el-table-column prop="comment.status" label="办理状态"> </el-table-column>
      <el-table-column prop="comment.message" label="审批意见"> </el-table-column>
