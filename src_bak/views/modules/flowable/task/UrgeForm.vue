<template>
  <v-dialog
    ...
    title="流程催办"
    v-model="visible">
    <el-form  ref="inputForm" :model="inputForm"   v-loading="loading" @keyup.enter="inputFormSubmit()" label-width="120px" @submit.prevent> 
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button  type="primary" @click="inputFormSubmit()" icon="circle-check" v-noMoreClick>确定</el-button>
      </span>
    </template>
  </v-dialog>
</template>
