      ...
      <div class="jp-table-body">
        ...
        >
          ...
          <vxe-column title="操作" width="200px" fixed="right" align="center">
            <template #default="scope">
              <el-button type="primary" text size="small" @click="design(scope.row)"
                >设计</el-button
              >
              <el-button type="primary" text size="small" @click="deploy(scope.row)"
                >发布</el-button
              >
              <el-dropdown style="margin-left: 10px">
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    ...
                    >
                    <!-- <el-dropdown-item
                      ><el-button type="primary" size="small" text @click="exportXML(scope.row)"
                        >导出</el-button
                      ></el-dropdown-item
                    > -->
                    <el-dropdown-item>
                      <el-button type="primary" size="small" text @click="copy(scope.row.id)"
                        >复制</el-button
                      >
                    </el-dropdown-item>
                    <el-dropdown-item>
                      <el-button type="danger" size="small" text @click="del(scope.row.id)"
                        >删除</el-button
                      >
                    </el-dropdown-item>
                  </el-dropdown-menu>
