<template>
  <div v-if="show" :key="data.key">
    <el-form label-position="top" size="default" :model="data">
      ...
      >
        <el-input clearable v-model="data.options.title"></el-input>
      </el-form-item>
      <el-form-item
        :label="$t('fm.config.widget.description')"
        v-if="Object.keys(data.options).indexOf('description') >= 0"
      >
        <el-input clearable v-model="data.options.description"></el-input>
      </el-form-item>
      <el-form-item
        ...
        <el-form-item :label="$t('fm.config.widget.steps')">
          ...
          <template v-else>
            ...
            <div style="margin-left: 5px">
              <el-button type="text" @click="handleAddStep">{{
                $t('fm.actions.addOption')
              }}</el-button>
            </div>
          </template>
      ...
      <template v-if="data.type == 'transfer'">
        <el-form-item :label="$t('fm.config.widget.option')">
          ...
          <template v-else>
            ...
            <div style="margin-left: 5px">
              <el-button type="text" @click="handleAddData">{{
                $t('fm.actions.addOption')
              }}</el-button>
              <el-button type="text" @click="handleClearSelect">{{
                $t('fm.actions.clearSelect')
      ...
      >
        <el-select v-model="data.options.buttonType" style="width: 100%">
          ...
          <el-option value="text" label="Text / Link"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item
      ...
      <template v-if="data.type == 'user'">
        <el-form-item :label="$t('fm.config.widget.userMax')">
          <el-input
            clearable
            type="number"
      ...
      >
        <el-form-item :label="$t('fm.config.widget.validate')">
          ...
          <div
            class="validate-block"
            v-if="Object.keys(data.options).indexOf('validator') >= 0"
          >
            <el-checkbox
              v-model="data.options.validatorCheck"
              style="margin-right: 10px"
              >{{ $t('fm.config.widget.customValidation') }}</el-checkbox
            >
...
export default {
  ...
  mounted() {
    ...
    dictService.list({ current: 1, size: -1 }).then((data) => {
