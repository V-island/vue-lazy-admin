<template>
  <div class="fm-uplaod-container" :id="uploadId">
    ...
    >
      <template #item="{ element: item }">
        ...
        >
          ...
          <el-progress
            v-if="item.status == 'uploading' && ui == 'element'"
            :width="miniWidth * 0.9"
          ...
          <a-progress
            v-if="item.status == 'uploading' && ui == 'antd'"
            :width="miniWidth * 0.9"
            class="upload-progress"
            type="circle"
          ...
          <div class="uplaod-action" :style="{ height: miniWidth / 4 + 'px' }">
            ...
            ></i>
            <i
              v-if="isEdit && !disabled && !printRead"
            ...
            <i
              v-if="
                isDelete && fileList.length > min && !disabled && !printRead
              "
    ...
    <div
      :class="{
        'is-disabled': disabled,
        'el-upload': ui == 'element',
        'el-upload--picture-card': ui == 'element',
        'ant-upload': ui == 'antd',
        'ant-upload-select': ui == 'antd',
        'ant-upload-select-picture-card': ui == 'antd',
      }"
