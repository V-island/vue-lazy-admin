...
// 加密方法
export function encrypt(encryptStr, key, options) {
  return sm4(encryptStr, key, 1, options)
}

// 解密方法
export function decrypt(decryptStr, key, options) {
  return sm4(decryptStr, key, 0, options)
}
