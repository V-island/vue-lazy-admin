<template>
  <div class="page">
    ...
    <el-row>
      ...
      <el-button-group class="pull-right">
        ...
        <el-tooltip class="item" effect="dark" content="刷新" placement="top">
          <el-button type="default" icon="refresh" @click="refreshList"> </el-button>
        </el-tooltip>
      </el-button-group>
    </el-row>
    <el-table
    ...
    >
      ...
      <el-table-column prop="category" header-align="center" align="center" label="流程分类">
        <template #default="scope">
          {{ $dictUtils.getDictLabel('act_category', scope.row.category, '') }}
        </template>
      </el-table-column>
      <el-table-column prop="key" header-align="center" align="center" label="流程标识">
      </el-table-column>
      <el-table-column
        prop="name"
        header-align="center"
      ...
      <el-table-column prop="resourceName" header-align="center" align="center" label="流程XML">
        <template #default="scope">
      ...
      <el-table-column prop="version" header-align="center" align="center" label="流程版本">
      </el-table-column>
      <el-table-column
        prop="suspended"
        header-align="center"
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="200" label="操作">
        <template #default="scope">
          <el-button text v-if="scope.row.suspended" @click="active(scope.row)">激活 </el-button>
          <el-button
            text
            v-if="_hasPermission('act:process:del')"
            @click="del(scope.row.deploymentId)"
            >删除
          </el-button>
          <el-button text v-if="!scope.row.suspended" @click="suspend(scope.row)">挂起 </el-button>
          <el-button text @click="toModel(scope.row)">转换为模型 </el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
  ...
  methods: {
    ...
    del(id) {
      ...
      this.$confirm(`确认要删除该流程吗?`, '提示', {
        ...
        this.$http
          .delete('/flowable/process/delete', { params: { deploymentIds: ids } })
          .then((data) => {
            if (data && data.success) {
